...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: LN - Wrong enqueuing position (inserted at front instead of back); GetNextPerson did not re-enqueue when Turns == 1.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: LN - GetNextPerson did not re add people in the queue who have infinite turns (Turns <= 0).
